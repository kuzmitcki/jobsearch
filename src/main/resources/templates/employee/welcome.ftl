...
<@p.page>
   <nav class="navbar navbar-expand-lg navbar-light bg-light mt-2">
    ...
    <div style="margin-left: 25%;margin-top: 10%;">
        <p style="margin-bottom: 0;width: 31%;font-size: 42px; color: #f60">Your next hire is here.</p>
        ...
        <a class="btn btn-primary" style="font-size: 24px; border-radius: 9px;" href="/job/wizard/information">Post job</a>
