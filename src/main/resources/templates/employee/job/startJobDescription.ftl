    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
     ...
     <div class="container h-100 " style=" font-family: Helvetica Neue,Helvetica,Arial,Liberation Sans,Roboto,Noto,sans-serif;">
         <div class="row h-100 justify-content-center align-items-center">
             <form style="margin-top: 6%;border-radius:25px;background-color: white; padding: 30px;" class="col-5" action="/job/wizard/job-description/basic"  method="post" >
                 <div style="color: #000;font-weight: normal; font-size: 23px;line-height: 28px; margin: 10px auto 13%;">Getting Started
                     <span style="font-size: 14px; color:#666; margin: 16%">Step 2 of 3</span>
                 </div>
                 <span style="font-size: 14px;color: red;margin-left: 32%;">${message!}</span>
                 ...
                 <div class="form-group">
                     <div class="form-group">
                         <label for="inputName" style="padding-top: 7%;color: #000;font-size: .875rem;letter-spacing: 0;line-height: 1.25rem;font-weight: 700;display: block;">
                             Company  <img style="margin-left: 5px;width: 14px" src="https://cdn3.iconfinder.com/data/icons/web-interface-6/10/star-red-512.png">
                         </label>
                         <input required style=" border-radius: 8px;" type="text" class="form-control" value="${employee.company!}" name="company" id="inputName" >
                     </div>
                 </div>
                 <div class="form-group">
                     <div class="form-group" style="margin-bottom: -1rem">
                         <label for="inputLocation" style="padding-top: 7%;color: #000;font-size: .875rem;letter-spacing: 0;line-height: 1.25rem;font-weight: 700;display: block;">
                             Job Location  <img style="width: 14px;margin-left: 5px;" src="https://cdn3.iconfinder.com/data/icons/web-interface-6/10/star-red-512.png">
                         </label>
                         <input  style=" border-radius: 8px;" type="text" class="form-control" name="jobLocation" id="inputLocation" >
                     </div>
                 </div>
                 ...
                 <div class="form-group">
                     <label class="control-label" style="font-size.875rem;font-weight: 400; display: inline-block; max-width: 100%;">
                         <div>
                             <div id="emailBox" style="margin-top: 2%;margin-bottom: 5%; display: none">
                                 <select  style="width: 106%; color: #4b4b4b; border-radius: 8px" class="custom-select" id="inputCountry" name="country">
                             ...
                             <strong style="color#666; line-height: 1.25rem;font-weight: 400;">United States – </strong>
