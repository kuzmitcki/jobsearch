    ...
    <div  class="row h-100 justify-content-center align-items-center">
        <div style="margin-bottom: 15%;width: 90%; background-color: white">
            <div style="margin-left: 25px;margin-top: 20px;">
                <div>
                    <strong>Company: </strong> ${employee.company!} <a style="font-size: 15px;float: right;font-weight: 300;margin-right: 30px;" id="company" href=""><input type="image" src="https://image.flaticon.com/icons/svg/660/660756.svg" style="height: auto;width: 1.2rem;float:"></a>
                </div>
                <div id="companyBox" style="display: none;padding-bottom: 2%;padding-top: 2%;">
                    <form method="post" action="/edit-employee/company">
                        <div class="form-group" style="width: 95%">
                            <input value="${employee.company!}"  style="border-radius: 8px;" type="text" class="form-control" name="company" id="inputCompany">
                        </div>
                        <div class="form-group">
                            <input type="hidden" name="_csrf" value="${_csrf.token}" />
                            <button type="submit" style="border-radius: 18px"  class="btn btn-primary">Save</button>
                        </div>
                    </form>
                </div>
                <div>
                ...
                <div style="padding-top: 4%;">
                    <strong>Job Description:</strong> <a style="font-size: 15px;float: right;font-weight: 300;margin-right: 30px;" id="description" href="#"><input type="image" src="https://image.flaticon.com/icons/svg/660/660756.svg" style="height: auto;width: 1.5rem;float:"></a>
                    ...
                    <div style="padding-top: 4%;padding-right: 3%">
                ...
                <div style="padding-top: 4%">
                    <strong>Desired Experience:</strong> <a style="font-size: 15px;float: right;font-weight: 300;margin-right: 30px;" id="experience" href="#"><input type="image" src="https://image.flaticon.com/icons/svg/660/660756.svg" style="height: auto;width: 1.5rem;float:"></a>
                ...
                <div style="padding-top: 4%">
                    <strong>Qualifications:</strong> <a style="font-size: 15px;float: right;font-weight: 300;margin-right: 30px;" id="qualification" href="#"><input type="image" src="https://image.flaticon.com/icons/svg/660/660756.svg" style="height: auto;width: 1.5rem;float:"></a>
...
<script>
    window.onload= function() {
        document.getElementById("company").onclick = function () {
            openBox("companyBox", this);
            return false;
        };
        document.getElementById("title").onclick = function () {
            openBox("titleBox", this);
            return false;
        };
        document.getElementById("location").onclick = function () {
            openBox("locationBox", this);
            return false;
        };
        document.getElementById("description").onclick = function () {
            openBox("descriptionBox", this);
            return false;
        };
        document.getElementById("experience").onclick = function () {
            openBox("experienceBox", this);
            return false;
        };
        document.getElementById("qualification").onclick = function () {
            openBox("qualificationBox", this);
            return false;
        }
