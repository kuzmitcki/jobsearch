                ...
                <div class="col" style="padding-top: 6%;">
                    ...
                    <label  for="inputWhere" style="color: #000;font-size: 1.4375rem;;letter-spacing: 0;line-height: 1.5rem;font-weight: 700;display: block;">
                        <div style="padding: 12px">
                            <span style="color: #767676;font-family: Helvetica Neue,Helvetica,Arial,Liberation Sans,Roboto,Noto,sans-serif;font-size: .75rem;letter-spacing: 0;line-height: 1.25rem;font-weight: 400;display: inline-block"><a href="/job/search/advanced">Advanced search</a></span>
                        </div>
                    </label>
                    <input type="hidden" name="_csrf" value="${_csrf.token}" />
                </div>
        ...
        <div class="row" style="padding-left: 9%">
            <#list jobs as job>
                <div style="width: 30%;background-color: white;padding-top: 1%;padding-bottom: 1%;margin: 10% 1% 0;" class="jumbotron">
                    <h1 style="font-size: 15px">${job.title!} - ${job.country}, ${job.jobLocation}</h1>
                    <p style="max-height:30px;font-size: 14px" class="lead">Salary:  (${job.fromSalary} to ${job.toSalary} $) per yer</p>
                    <hr class="my-4">
                    <h1 style="font-size: 15px">Desired Experience:</h1>
                    <div style="padding-top: 1%; padding-right: 3%">
                        <pre style="max-height:100px;font-family: Helvetica Neue,Helvetica,Arial,Liberation Sans,Roboto,Noto,sans-serif;font-size: .875rem;letter-spacing: 0;line-height: 1.25rem;font-weight: 400;">${job.desiredExperience!}</pre>
                    </div>
                    <div>
                        <a style="font-size: 14px" class="btn btn-primary" href="/job/preview/${job.id}" >Learn more</a>
                    </div>
                </div>
            </#list>
        </div>
